...
Frontend del sistema de gestión de facturas de **NexTech / RS Tech Limitada**. Aplicación web SPA (Single Page Application) construida con React 19 y Vite, que consume la API REST del backend Spring Boot.
